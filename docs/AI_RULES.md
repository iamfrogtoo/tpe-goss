...
* **OpenSky Network API**：
  * 無需認證檔，直接使用公開 API endpoint
  * URL: `https://opensky-network.org/api/states/all?lamin=24.0&lomin=120.0&lamax=26.0&lomax=122.0`
...
4. **SSH 密碼**：`zhi52401314`（但建議用戶設定 SSH Key 以提升安全性）
